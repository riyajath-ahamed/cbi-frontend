...
const MissionCard = () => {
  return (
      <div className=" bg-transparent mx-auto max-w-7xl py-12 px-4 sm:px-6 sm:py-24 lg:px-8">
        <div className=" overflow-hidden bg-green-600 px-6 pt-16 pb-11 shadow-2xl rounded-lg sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
